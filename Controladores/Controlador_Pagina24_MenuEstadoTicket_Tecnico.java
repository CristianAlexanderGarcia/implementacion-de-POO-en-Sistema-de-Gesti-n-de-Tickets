...
public class Controlador_Pagina24_MenuEstadoTicket_Tecnico implements Initializable {

    @FXML
    private Button RegresaAlmamenu;
    ...
    void Regreso(ActionEvent event) {
        try {
            ...
            Stage stage = (Stage) RegresaAlmamenu.getScene().getWindow();
